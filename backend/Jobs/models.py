...
class Jobs(models.Model):
    ...
    location = models.CharField(choices=LOCATION_CHOICES,default='MO',null=True,max_length=50)
    job_type = models.CharField(choices=JOB_TYPE_CHOICES,default='FULL',null=True,max_length=10)
